...
const pillars = [
  {
    title: "Our Mission",
    description:
      "To make world-class hair and skin care effortlessly accessible in Tirupur — combining clinical precision with a calm, considered patient experience.",
    icon: Compass,
  },
  {
    title: "Our Vision",
      ...
      <section className="section">
        <div className="container-px mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="A few things our clients in Tirupur often ask before their first visit."
          />
