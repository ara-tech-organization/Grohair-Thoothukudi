        ...
        <div className="container-px relative mx-auto max-w-7xl pb-24 pt-16 sm:pt-20 lg:pb-32 lg:pt-28">
          <div className="max-w-2xl">
            ...
            >
              ...
              and skin health to Warangal. Our certified trichologists and
          ...
          <div className="grid items-start gap-14 lg:grid-cols-12">
            <div className="lg:col-span-5">
              <SectionHeader
                ...
                description="Advanced GroHair and GloSkin combine deep expertise in hair and skin wellness with the serene pace of Warangal. Our clinic blends clinical precision with a luxurious experience, delivered by trained professionals in a safe, sterile setting."
              />
              <p className="mt-6 max-w-md text-sm leading-relaxed text-ink-500">
                At our Warangal center, you'll find the best of science,
